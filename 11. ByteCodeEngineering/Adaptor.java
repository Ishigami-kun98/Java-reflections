...
public class Adaptor implements Translator{
    ...
    public void onLoad(ClassPool pool, String arg1) throws NotFoundException, CannotCompileException {
        try {
            ...
            ctMethod.addLocalVariable("AppendResutl", CtClass.longType);
            ...
            ctMethod.instrument(new ExprEditor(){
                public void edit(final MethodCall m) throws CannotCompileException{
                    if(m.getClassName().equals("java.lang.StringBuilder") && m.getMethodName().equals(append.getName()) && m.getSignature().equals(append.getSignature())){
                    ...
                    if(m.getClassName().equals("java.lang.StringBuilder") && m.getMethodName().equals(insert.getName()) && m.getSignature().equals(insert.getSignature())){
                        m.replace("{long appendStartMs = System.nanoTime(); " + 
                        "$_ = $proceed($$);" +
                        "long appendEndMs = System.nanoTime();" +
